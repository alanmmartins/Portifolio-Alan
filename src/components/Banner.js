        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          >
            ...
            >
              ...
              <TypeAnimation
                sequence={['Tecnico Industrial', 2000, 'Desenvolvedor Front-end', 2000]}
                speed={50}
            ...
            >
              Formado em Análise e Desenvolvimento de Sistemas, Academico do CO.DE SCHOOL FGVW
            </motion.p>
            <motion.div
              variants={animationVariants}
              initial='hidden'
            ...
            >
              <a href="https://github.com/alanmmartins" target="_blank" rel="noopener noreferrer">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/alanmmartins/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin />
              </a>
              <a href="mailto:alanmunozmartins@gmail.com?subject=Assunto do email&body=Entrar em contato :)"
                target="_blank" rel="noopener noreferrer"
              >
                <FaMailBulk />
              </a>
              <a href="https://wa.link/mm1vxi" target="_blank" rel="noopener noreferrer">
                <FaWhatsapp />
              </a>
            </motion.div>
