        ...
        <div className='flex flex-col md:flex-row text-center items-center justify-center'>
          ...
          >
            <div className='pb-2'>
              ...
              <p className='text-base md:text-lg lg:text-xl'>Aqui estão três exemplos de páginas web desenvolvidas com o framework Tailwind, desenvolvidos durante o cursos paralelos a minha formação. Clique no botão abaixo e entre em contato comigo!</p>
